...
class SystemTrayAgent(QtWidgets.QSystemTrayIcon):
    ...
    def stop_agent(self):
        ...
        if not self.agent_thread or not self.agent_thread.is_alive():
            self.showMessage("Office Agent", "Agent is not running", QtWidgets.QSystemTrayIcon.Information, 2000)
            return
        ...
        self.showMessage("Office Agent", "Agent stopped", QtWidgets.QSystemTrayIcon.Information, 2000)
